            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="#">Anime List</a>
                        <span>Episodes</span>
                        <a>Welcome, <%out.print(session.getAttribute("uname")); %> </a>
    <a href="logout" class="w3-padding-large w3-hover-red w3-hide-small w3-right"><i class="fa-solid fa-right-to-bracket w3-hover-opacity" ></i></a>
                    </div>
                </div>
            </div>
        </div>
